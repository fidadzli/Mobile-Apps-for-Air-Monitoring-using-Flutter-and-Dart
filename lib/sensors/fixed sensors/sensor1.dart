...
class _Sensor1State extends State<Sensor1> {
  ...
  void _activateListeners() {
    _streamSubs = databaseReference
      ...
      Map<dynamic, dynamic> sensor1Data = droneSensorData['sensor1'] as Map<dynamic, dynamic>;
      dynamic latestSensor1Value = sensor1Data.values.last;

      setState(() {
        a = '$latestSensor1Value';
        sensor1data = double.parse(a);
        chartData.add(LiveData(time++, sensor1data));
