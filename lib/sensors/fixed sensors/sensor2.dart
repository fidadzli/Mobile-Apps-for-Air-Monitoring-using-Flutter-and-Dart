...
class _Sensor2State extends State<Sensor2> {
  ...
  void _activateListeners() {
    _streamSubs = databaseReference
      ...
      Map<dynamic, dynamic> sensor2Data = droneSensorData['sensor2'] as Map<dynamic, dynamic>;
      dynamic latestSensor2Value = sensor2Data.values.last;

      setState(() {
        a = '$latestSensor2Value';
        sensor2data = double.parse(a);
        chartData.add(LiveData(time++, sensor2data));
