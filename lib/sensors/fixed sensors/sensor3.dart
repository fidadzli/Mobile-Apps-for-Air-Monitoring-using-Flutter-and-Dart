...
class Sensor3 extends StatefulWidget {
  const Sensor3({Key? key}) : super(key: key);
...
class _Sensor3State extends State<Sensor3> {
  ...
  void _activateListeners() {
    _streamSubs = databaseReference
      ...
      Map<dynamic, dynamic> sensor3Data = droneSensorData['sensor3'] as Map<dynamic, dynamic>;
      dynamic latestSensor3Value = sensor3Data.values.last;

      setState(() {
        a = '$latestSensor3Value';
        sensor3data = double.parse(a);
        chartData.add(LiveData(time++, sensor3data));
